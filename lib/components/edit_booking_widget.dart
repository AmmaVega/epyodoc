                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '4paqfjyu' /* Edite los campos a continuació... */,
                                  ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '2tupmp5z' /* Confirmación será enviada a: */,
                            ),
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'ma48k5m2' /* Seleccione fecha y hora */,
                                              ),
                                              style:
