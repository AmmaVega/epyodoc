                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'hmmu44rz' /* Fill out the information below... */,
                            ),
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      options: [
                        FFLocalizations.of(context).getText(
                          'y06hdr6e' /* Doctors Visit */,
                        ),
                        FFLocalizations.of(context).getText(
                          'qc9wcm9y' /* Routine Checkup */,
                        ),
                        FFLocalizations.of(context).getText(
                          '0agzgs60' /* Scan/Update */,
                        )
                      ],
