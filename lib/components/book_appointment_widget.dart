                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '3hs8sovq' /* Registro de Citas Programadas */,
                                ),
                              ...
                              children: [
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'ydg2j7he' /* Complete la información a cont... */,
                                      ),
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'lrq3ljxh' /* Emails will be sent to: */,
                                ),
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'rdlcjvv2' /* Describa brevemente su estado
... */
                                    ,
                                  ),
                                  labelStyle:
