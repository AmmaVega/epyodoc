    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'userSex':
          ...
          break;
        case 'rolusuario':
          result.rolusuario = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  String? _rolusuario;
  String? get rolusuario => _$this._rolusuario;
  set rolusuario(String? rolusuario) => _$this._rolusuario = rolusuario;
